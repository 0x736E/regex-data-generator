...
class RegexDataGenerator {
  ...
  */
  ...
  static generatePattern(targetPatterns, sampleCount, callback, selector, format) {
    ...
    return new Promise((resolve, reject) => {
      ...
      switch ( format.toUpperCase() ) {
        ...
        case 'XML':
          return self.#generatePatternsAsXML(targetPatterns, sampleCount, callback, selector);
          break;

        case 'YAML':
          return self.#generatePatternsAsYAML(targetPatterns, sampleCount, callback, selector);
          break;
  ...
  static #generatePatternsAsXML(targetPatterns, sampleCount, callback, selector) {
  ...
  static #generatePatternsAsYAML(targetPatterns, sampleCount, callback, selector) {
    ...
    return new Promise((resolve, reject) => {
      ...
      for ( let id of targetPatternKeys ) {
        ...
        outData = dataGen.generateFromRegex(sampleCount, (result) => {
          outData[id] = result.sample;
          callback(yaml.stringify(outData));
        });
      }
  ...
  static async generateAsFiles ( config, patterns, callback, index ) {
    ...
    let outputAsJSON = (config.format && config.format.toUpperCase() === 'JSON') ;
